...
fn es(s: &str) -> Option<&'static str> {
    Some(match s {
        ...
        // ---- Consent / privacy ----
        "Share crash reports?" => "¿Compartir informes de fallos?",
        "Share product analytics?" => "¿Compartir analítica de uso?",
        "Crash reports" => "Informes de fallos",
        "Optional technical crash and sign-in reports." => "Informes técnicos opcionales de fallos e inicio de sesión.",
        "Product analytics" => "Analítica de uso",
        "Optional feature and playback outcomes." => "Resultados opcionales de funciones y reproducción.",
        "Crashes / Errors" => "Fallos / Errores",
        "Analytics / Usage" => "Analítica / Uso",
        "See an example report" => "Ver un informe de ejemplo",
        "Privacy policy" => "Política de privacidad",
        "Analytics ID" => "ID de analítica",
        "Crash report ID" => "ID de informe de fallos",
        "Delete all local data" => "Borrar todos los datos locales",
        "Reporting" => "Informes",
        "On this TV" => "En esta TV",
        "Field-by-field preview of the crash/error report." => "Vista campo a campo del informe de fallos/errores.",
        "Field-by-field preview of product analytics events." => "Vista campo a campo de los eventos de analítica.",
        "The complete butaca privacy policy for this build." => "La política de privacidad completa de butaca para esta compilación.",
        "The identifier on your crash reports, and how to have them deleted." => "El identificador de tus informes de fallos y cómo pedir su borrado.",
        "The identifier on your analytics, and how to have it deleted." => "El identificador de tu analítica y cómo pedir su borrado.",
        "Sign out and remove butaca data from this TV." => "Cierra sesión y elimina los datos de butaca de esta TV.",
        // ---- Consent re-ask / extension notes ----
        "Asking again because what is collected has changed: " => "Te preguntamos de nuevo porque ha cambiado lo que se recopila: ",
        "Crash reports can now include a playback error report with its steps." => "Los informes de fallos ahora pueden incluir un informe de error de reproducción con sus pasos.",
        "Crash reports can now include a sign-in error report." => "Los informes de fallos ahora pueden incluir un informe de error de inicio de sesión.",
        "Reports can now say how your sign-in is stored." => "Los informes ahora pueden indicar cómo se guarda tu inicio de sesión.",
        "Reports can now include how your sign-in is stored." => "Los informes ahora pueden incluir cómo se guarda tu inicio de sesión.",
...
mod tests {
    ...
    fn the_spanish_table_carries_no_empty_entry() {
        for key in [
            ...
            "Crash reports",
            "Optional technical crash and sign-in reports.",
            "Product analytics",
            "Optional feature and playback outcomes.",
            "Crashes / Errors",
            "Analytics / Usage",
            ...
            "Reporting",
            "On this TV",
            "Field-by-field preview of the crash/error report.",
            "Field-by-field preview of product analytics events.",
            "The complete butaca privacy policy for this build.",
            "The identifier on your crash reports, and how to have them deleted.",
            "The identifier on your analytics, and how to have it deleted.",
            "Sign out and remove butaca data from this TV.",
            "Asking again because what is collected has changed: ",
